...
import com.intonate.app.MyApplication;

public class FontHelper {

    public enum FontType {

        FONT_BOLD("fonts/Lato-Bold.ttf"),
        FONT_MEDIUM("fonts/Lato-Medium.ttf"),
        FONT_REGULAR("fonts/Lato-Regular.ttf");
